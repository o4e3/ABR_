...
enum MessageType
{
    ABRTYPE_RREQ = 1,    //!< ABRTYPE_RREQ
    ABRTYPE_RREP = 2,    //!< ABRTYPE_RREP
    ABRTYPE_RERR = 3,    //!< ABRTYPE_RERR
    ABRTYPE_RREP_ACK = 4 //!< ABRTYPE_RREP_ACK
};
...
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * \param t the ABR RREQ type
     */
    TypeHeader(MessageType t = ABRTYPE_RREQ);
